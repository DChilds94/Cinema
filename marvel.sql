...
-- The cinema would also like to make the Guardian movies a back to back feature.
-- Update the 'Guardians of the Galaxy' show time from 15:30 to 21:00,
-- and the 'Guardians of the Galaxy 2' show time from '16:30' to '22:00
